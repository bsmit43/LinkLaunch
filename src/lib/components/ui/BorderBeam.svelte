...
<div
	...
	style="--size: {size}; --duration: {duration}s; --anchor: {anchor}; --border-width: {borderWidth}; --color-from: {colorFrom}; --color-to: {colorTo}; --delay: {delay}s;"
></div>
